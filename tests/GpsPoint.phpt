...
Assert::same(49.0505547, $object->getLat());
Assert::same(14.4423873, $object->getLng());
...
Assert::same(49.0545128, $object->getLat());
Assert::same(14.433819, $object->getLng());
...
foreach ($array as $value) {
	...
	$diffLat = $object->getLat() - 49.0506117;
	$diffLng = $object->getLng() - 14.4420556;
